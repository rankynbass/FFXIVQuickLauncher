...
public class CompatibilityTools
{
    ...
    private const string WINE_XIV_RELEASE_URL = "https://github.com/goatcorp/wine-xiv-git/releases/download/7.15.r4.gfa8d0abc/wine-xiv-staging-fsync-git-arch-7.15.r4.gfa8d0abc.tar.xz";
#elif WINE_XIV_FEDORA_LINUX
    private const string WINE_XIV_RELEASE_URL = "https://github.com/goatcorp/wine-xiv-git/releases/download/7.15.r4.gfa8d0abc/wine-xiv-staging-fsync-git-fedora-7.15.r4.gfa8d0abc.tar.xz";
#else
    private const string WINE_XIV_RELEASE_URL = "https://github.com/goatcorp/wine-xiv-git/releases/download/7.15.r4.gfa8d0abc/wine-xiv-staging-fsync-git-ubuntu-7.15.r4.gfa8d0abc.tar.xz";
#endif
    private const string WINE_XIV_RELEASE_NAME = "wine-xiv-staging-fsync-git-7.15.r4.gfa8d0abc";
